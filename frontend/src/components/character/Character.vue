  ...
  <div>
    <div class="avatar cursor-pointer" @mouseover="isHover=true" @mouseout="isHover=false">
      <div class="w-60 h-100 rounded-2xl relative">
        <img :src="character.background_image" class="transition-transform duration-300" :class="{'scale-120': isHover}" alt="" @click="openChatField" />
        ...
        <div class="absolute left-4 top-54 avatar">
          <div class="w-16 rounded-full ting-3 ring-white">
